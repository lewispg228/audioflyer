  ...
  if (gSeqMetro.check() == 1) {
      ...
      switch (gSeqState) {
          ...
          case 0:
              ...
              delay(delay_time);
              Serial.print("4");
              tsunami.trackPlayPoly(1, 0, true);     // Start Track 2
              tsunami.trackPlayPoly(2, 1, true);
              delay(delay_time);
              tsunami.trackFade(1, 0, 50, false);  // Fade Track 2 to 0dB over 2 sec
              tsunami.trackFade(2, 0, 50, false);
          ...
          case 1:
              ...
              tsunami.trackFade(1, -40, 3000, true); // Fade Track 2 down to -40dB over 3 secs and stop
              //Serial.print("Waiting for Track 1 to finish... ");
              gSeqState = 3;                         // Advance to state 2
          break;
